  ...
  return (
    <div className="rounded-3xl bg-white p-5 shadow-md shadow-black/5">
      ...
      <div className="mt-4 space-y-3">
        ...
        {/* Java */}
        <div className="flex items-start justify-between gap-3 rounded-xl border border-dashed border-black/10 bg-slate-50 p-3">
          <div className="flex items-start gap-2.5">
          ...
          >
            {backend.kind === "desktop" ? "Offline ✓" : "Online / Desktop"}
          </span>
        </div>
      </div>

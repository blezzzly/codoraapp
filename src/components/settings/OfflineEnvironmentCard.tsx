...
import { currentBackend } from "@/lib/executionBackend";
        ...
        <div className="rounded-xl border border-black/5 bg-slate-50 p-3">
          <div className="flex items-start gap-2.5">
            ...
            <div>
              ...
              <p className="text-[11px] leading-snug text-muted-foreground">
                A browser sandbox has no JVM, so Java cannot run offline here.
                Java runs through the online judge (with your consent) or a
                local JDK in the desktop app — no download needed.
              </p>
            </div>
          </div>
        </div>
